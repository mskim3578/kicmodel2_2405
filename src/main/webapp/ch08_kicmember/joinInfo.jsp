...
<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				href=
	"<%=request.getContextPath() %>/ch08_kicmember/memberUpdateForm.jsp">
				회원정보수정</a>
				<a class="btn btn-primary"
	href="<%=request.getContextPath() %>/ch08_kicmember/memberDeleteForm.jsp">
	회원탈퇴</a>
				<a class="btn btn-primary"
	href="<%=request.getContextPath() %>/ch08_kicmember/memberPassForm.jsp">
	비밀번호수정</a>
				</td>
			</tr>
